...
class ScanResultTile extends StatefulWidget {
  const ScanResultTile({super.key, required this.result, this.onTap, required this.connecting, this.onOpen});
...
class _ScanResultTileState extends State<ScanResultTile> {
    ...
    if (widget.result.advertisementData.connectable) {
      if (widget.connecting)
        ...
        return ElevatedButton(
          ...
          onPressed: (widget.result.advertisementData.connectable) ? widget
              .onTap : widget.onOpen,
  ...
  Widget build(BuildContext context) {
    ...
    if (_buildConnectButton(context) != null) {
